            ...
            case 'plan-management':
                return (
                    <div className="bg-white rounded-lg shadow p-6">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">Plan Management</h2>
                        <p className="text-gray-600">Plan management functionality will be implemented here.</p>
                    </div>
                );
            case 'payments':
                return (
                    <div className="bg-white rounded-lg shadow p-6">
                        ...
                        <p className="text-gray-600">Payment management functionality will be implemented here.</p>
                    </div>
                );
            case 'support':
                return (
